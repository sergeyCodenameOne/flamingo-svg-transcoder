...
/**
 * Transcodes a rectangle.
 * 
 * @author Emmanuel Bourg
 * @version $Revision$, $Date$
 */
public class RectangleTranscoder extends Transcoder<Rectangle2D> {

    public static RectangleTranscoder INSTANCE = new RectangleTranscoder();

    @Override
    public void transcode(Rectangle2D rect, PrintWriter output) {
