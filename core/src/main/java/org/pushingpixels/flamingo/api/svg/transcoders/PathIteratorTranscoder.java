...
/**
 * Transcodes a path iterator.
 * 
 * @author Emmanuel Bourg
 * @version $Revision$, $Date$
 */
public class PathIteratorTranscoder extends Transcoder<PathIterator> {
    
    public static PathIteratorTranscoder INSTANCE = new PathIteratorTranscoder();

    @Override
    public void transcode(PathIterator pathIterator, PrintWriter output) {
